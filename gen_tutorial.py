...
step("00-why-omnist", "Why Omnist", "The problem this exists to solve, and what it makes possible.", "".join([
    ...
    '<li><b>A schema algebra, not just a schema.</b> Trimming a schema down to what one service actually uses, or drafting one from real examples instead of writing it by hand, are both single decidable operations — <code>extract</code> and <code>infer</code> — not scripts you'
    "'"
